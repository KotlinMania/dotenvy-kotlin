...
kotlin {
    ...
    val xcf = XCFramework("Dotenvy")

    macosArm64 {
        binaries.framework { baseName = "Dotenvy"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Dotenvy"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Dotenvy"
        flattenPackage = "io.github.kotlinmania.dotenvy"
    }

    android {
        namespace = "io.github.kotlinmania.dotenvy"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "dotenvy-kotlin", version.toString())

    pom {
        name.set("dotenvy-kotlin")
        description.set("Kotlin Multiplatform port of allan2/dotenvy - A well-maintained fork of the dotenv crate")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/dotenvy-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/dotenvy-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/dotenvy-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/dotenvy-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.dotenvy.codeql
...
tasks.named("linkReleaseFrameworkMacosArm64") {
    outputs.upToDateWhen {
        layout.buildDirectory.file("bin/macosArm64/releaseFramework/Dotenvy.framework/Dotenvy")
            .get()
            .asFile
            .exists()
    }
