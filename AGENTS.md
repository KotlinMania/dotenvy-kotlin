...
This file is the quick-reference operating contract for dotenvy-kotlin. The longer
...
dotenvy-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`dotenvy`](https://crates.io/crates/dotenvy). Upstream Rust is the behavioral oracle while the
