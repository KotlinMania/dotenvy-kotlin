...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Dotenvy.swiftmodule/`
...
//      `import Dotenvy` above would fail at compile time.
//
//   2. The static archive `libDotenvy.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Dotenvy" }` and
//      `flattenPackage = "io.github.kotlinmania.dotenvy"` configuration in
...
//      via the `DotenvyLibrary` product.
//
